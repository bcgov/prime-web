...
import { StatusMsgInterface, ScreenAreaID } from '../../../../../src/app/models/api-base.model';
...
export class FakeBackendService {
  ...
  public messageList: StatusMsgInterface[] = [
    {msgID: '1',
     ...
     appLayer: 'ALL'},
    {msgID: '10',
     msgText: 'Invalid password, please enter a correct password or contact an Administrator. (0010)',
     msgType: '1',
     scrArea: ScreenAreaID.CONFIRMATION,
     appLayer: 'ALL'},
    {msgID: '101',
     ...
     appLayer: 'ALL'},
    {msgID: '104',
     msgText: 'A potential duplicate Identity has been detected and you will need to complete ID Proofing to resolve (0104)',
     msgType: '2',
     scrArea: ScreenAreaID.CONFIRMATION,
     appLayer: 'ALL'},
    {msgID: '105',
     msgText: 'You can update your Registration information but cannot enroll in PRIME until you have ID-Proofed to resolve duplicate(s) (0105)',
     msgType: '2',
     scrArea: ScreenAreaID.CONFIRMATION,
     appLayer: 'ALL'},
    {msgID: '106',
     msgText: 'Authentication failed, please retry or contact an administrator (0106)',
     msgType: '1',
     scrArea: ScreenAreaID.CONFIRMATION,
     appLayer: 'ALL'},
    {msgID: '11',
     msgText: 'Mailing Address must be within Canada when Hard Token is selected. Choose another Multi-factor login method or update your mailing address to a Canadian mailing address. (0011)',
     msgType: '1',
     scrArea: ScreenAreaID.CONFIRMATION,
     appLayer: 'ALL'},
    {msgID: '111',
     ...
     appLayer: 'ALL'},
    {msgID: '113',
     msgText: 'Please contact an ICBC/Service BC agent to update the identity information (0113)',
     msgType: '2',
     scrArea: ScreenAreaID.CONFIRMATION,
     appLayer: 'ALL'},
    {msgID: '114',
     msgText: 'MoH credential has been successfully added. A duplicate Identity has been detected that will need to be resolved during ID Proofing (0114)',
     msgType: '2',
     scrArea: ScreenAreaID.CONFIRMATION,
     appLayer: 'ALL'},
    {msgID: '121',
     ...
     appLayer: 'ALL'},
    {msgID: '122',
     msgText: 'Please ID Proof to complete the Registration Identity information updates (0122)',
     msgType: '2',
     scrArea: ScreenAreaID.CONFIRMATION,
     appLayer: 'ALL'},
    {msgID: '124',
     msgText: 'Duplicate Contact info found. Please change the Email address or contact an Administrator. (0124)',
     msgType: '1',
     scrArea: ScreenAreaID.CONFIRMATION,
     appLayer: 'ALL'},
    {msgID: '125',
     msgText: 'Duplicate Contact info found. Please change the recovery SMS phone number or contact an Administrator. (0125)',
     msgType: '1',
     scrArea: ScreenAreaID.CONFIRMATION,
     appLayer: 'ALL'},
    {msgID: '126',
     msgText: 'Registration information has been successfully updated and you will be sent a hard token to the mailing address provided  (0126)',
     msgType: '0',
     scrArea: ScreenAreaID.CONFIRMATION,
     appLayer: 'ALL'},
    {msgID: '127',
     msgText: 'You have removed all the Multi Factor Authentication options. Please add a Multi Factor Authentication option and complete ID Proofing to continue access (0127)',
     msgType: '2',
     scrArea: ScreenAreaID.CONFIRMATION,
     appLayer: 'ALL'},
    {msgID: '128',
     msgText: 'Registration information has been successfully updated, please complete ID Proofing. (0128)',
     msgType: '0',
     scrArea: ScreenAreaID.CONFIRMATION,
     appLayer: 'ALL'},
    {msgID: '129',
     msgText: 'Please ID Proof to complete Multi Factor authentication setup (0129)',
     msgType: '2',
     scrArea: ScreenAreaID.CONFIRMATION,
     appLayer: 'ALL'},
    {msgID: '130',
     msgText: 'This information can only be updated after logging in with Multi Factor authentication (0130)',
     msgType: '2',
     scrArea: ScreenAreaID.CONFIRMATION,
     appLayer: 'ALL'},
    {msgID: '131',
     msgText: 'You have removed all the Multi Factor Authentication options, please add a Multi Factor Authentication option to continue access.\nIf you do not add a multi factor authentication option now, then you will be required to add a Multi Factor authentication option and complete ID Proofing (0131)',
     msgType: '2',
     scrArea: ScreenAreaID.CONFIRMATION,
     appLayer: 'ALL'},
    {msgID: '151',
    ...
    {msgID: '152',
     ...
     appLayer: 'ALL'},
    {msgID: '153',
     msgText: 'Information provided does not match the Registration information. Please try again or contact an administrator (0153)',
     msgType: '1',
     scrArea: ScreenAreaID.CONFIRMATION,
     appLayer: 'ALL'},
    {msgID: '154',
     msgText: 'You have exceeded the number of retries to answer the security questions provided. Please contact an Administrator. (0154)',
     msgType: '1',
     scrArea: ScreenAreaID.CONFIRMATION,
     appLayer: 'ALL'},
    {msgID: '161',
     msgText: 'The UserID has been sent to the email address or SMS phone number provided (0161)',
     msgType: '0',
     scrArea: ScreenAreaID.CONFIRMATION,
     appLayer: 'ALL'},
    {msgID: '162',
     msgText: 'The CAPTCHA response provided does not match. Please try again. (0162)',
     msgType: '1',
     scrArea: ScreenAreaID.CONFIRMATION,
     appLayer: 'ALL'},
    {msgID: '181',
     msgText: 'Registered User\'s Identity has been successfully Deactivated (0181)',
     msgType: '0',
     scrArea: ScreenAreaID.CONFIRMATION,
     appLayer: 'ALL'},
    {msgID: '182',
     msgText: 'Please enter a Deactivation Reason to complete processing (0182)',
     msgType: '1',
     scrArea: ScreenAreaID.CONFIRMATION,
     appLayer: 'ALL'},
    {msgID: '183',
    ...
    {msgID: '20',
     ...
     appLayer: 'ALL'},
    {msgID: '200',
     msgText: 'Registered User Identity has been successfully Reactivated (0200)',
     msgType: '0',
     scrArea: ScreenAreaID.CONFIRMATION,
     appLayer: 'ALL'},
    {msgID: '201',
     msgText: 'Please enter a Reactivation Reason to complete processing (0201)',
     msgType: '1',
     scrArea: ScreenAreaID.CONFIRMATION,
     appLayer: 'ALL'},
    {msgID: '202',
    ...
    {msgID: '21',
     ...
     appLayer: 'ALL'},
    {msgID: '22',
     msgText: 'Multi-factor code could not be verified. Please retry or request a new code. (0022)',
     msgType: '1',
     scrArea: ScreenAreaID.CONFIRMATION,
     appLayer: 'ALL'},
    {msgID: '221',
    ...
    {msgID: '222',
     ...
     appLayer: 'ALL'},
    {msgID: '23',
     msgText: 'You have exceeded the maximum login attempts, please wait 15 minutes before trying again. (0023)',
     msgType: '1',
     scrArea: ScreenAreaID.CONFIRMATION,
     appLayer: 'ALL'},
    {msgID: '24',
     msgText: 'You have exceeded the maximum login attempts, please contact your administrator to resolve. (0024)',
     msgType: '1',
     scrArea: ScreenAreaID.CONFIRMATION,
     appLayer: 'ALL'},
    {msgID: '25',
    ...
    {msgID: '3',
     ...
     appLayer: 'ALL'},
    {msgID: '4',
     msgText: 'Please log on to complete ID Proofing. Your Hard Token will be sent after you successfully complete ID Proofing. (0004)',
     msgType: '0',
     scrArea: ScreenAreaID.CONFIRMATION,
     appLayer: 'ALL'},
    {msgID: '5',
     msgText: 'Account successfully created. A duplicate Identity has been detected that will need to be resolved during ID Proofing (0005)',
     msgType: '2',
     scrArea: ScreenAreaID.CONFIRMATION,
     appLayer: 'ALL'},
    {msgID: '9',
     msgText: 'UserID provided is already in use, please enter a different UserID or contact an Administrator. (0009)',
     msgType: '1',
     scrArea: ScreenAreaID.CONFIRMATION,
     appLayer: 'ALL'},
    {msgID: '9998',
     msgText: 'This error occurred due to a unanticipated non-system related issue. (9998)',
     msgType: '1',
     scrArea: ScreenAreaID.CONFIRMATION,
     appLayer: 'ALL'},
    {msgID: '9999',
     msgText: 'This error occurred because the system encountered an unanticipated situation which  forced it to stop. (9999)',
     msgType: '1',
     scrArea: ScreenAreaID.CONFIRMATION,
     appLayer: 'ALL'}
  ];

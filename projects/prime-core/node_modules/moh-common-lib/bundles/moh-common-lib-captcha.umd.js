(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/forms'), require('@angular/core'), require('@angular/common/http'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('moh-common-lib/captcha', ['exports', '@angular/forms', '@angular/core', '@angular/common/http', '@angular/common'], factory) :
    (factory((global['moh-common-lib'] = global['moh-common-lib'] || {}, global['moh-common-lib'].captcha = {}),global.ng.forms,global.ng.core,global.ng.common.http,global.ng.common));
}(this, (function (exports,forms,core,http,common) { 'use strict';
    ...
    var CaptchaDataService = /** @class */ (function () {
        ...
        /** @nocollapse */
        CaptchaDataService.ctorParameters = function () {
            return [
    ...
    var CaptchaComponent = /** @class */ (function () {
        function CaptchaComponent(dataService, cd, ngZone) {
            ...
            this.onValidToken = new core.EventEmitter();
            this.language = 'en';
            /**
        ...
        CaptchaComponent.propDecorators = {
            imageContainer: [{ type: core.ViewChild, args: ['image',] }],
            audioElement: [{ type: core.ViewChild, args: ['audioElement',] }],
            apiBaseUrl: [{ type: core.Input, args: ['apiBaseUrl',] }],
            nonce: [{ type: core.Input, args: ['nonce',] }],
            onValidToken: [{ type: core.Output }],
            successMessage: [{ type: core.Input, args: ['successMessage',] }],
            eagerFetchAudio: [{ type: core.Input, args: ['eagerFetchAudio',] }],
            language: [{ type: core.Input, args: ['language',] }],
            userPromptMessage: [{ type: core.Input, args: ['userPromptMessage',] }]
        };
...
//# sourceMappingURL=moh-common-lib-captcha.umd.js.map
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('zxcvbn'), require('ngx-bootstrap'), require('moment'), require('ngx-mydatepicker'), require('rxjs'), require('rxjs/operators'), require('angular2-uuid'), require('@angular/router'), require('blueimp-load-image'), require('sha1'), require('pdfjs-dist'), require('angular2-text-mask'), require('@angular/forms'), require('@ng-select/ng-select'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('moh-common-lib', ['exports', '@angular/common', 'zxcvbn', 'ngx-bootstrap', 'moment', 'ngx-mydatepicker', 'rxjs', 'rxjs/operators', 'angular2-uuid', '@angular/router', 'blueimp-load-image', 'sha1', 'pdfjs-dist', 'angular2-text-mask', '@angular/forms', '@ng-select/ng-select', '@angular/core'], factory) :
    (factory((global['moh-common-lib'] = {}),global.ng.common,global.zxcvbn_,global.ngxBootstrap,global.moment_,global.ngxMydatepicker,global.rxjs,global.rxjs.operators,global.angular2Uuid,global.ng.router,global.loadImage_,global.sha1_,global.PDFJS_,global.angular2TextMask,global.ng.forms,global.ngSelect,global.ng.core));
}(this, (function (exports,common,zxcvbn_,ngxBootstrap,moment_,ngxMydatepicker,rxjs,operators,angular2Uuid,router,loadImage_,sha1_,PDFJS_,angular2TextMask,forms,ngSelect,core) { 'use strict';
    ...
    var FormActionBarComponent = /** @class */ (function () {
        ...
        FormActionBarComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        viewProviders: [{ provide: forms.ControlContainer, useExisting: core.forwardRef(( /**
                                         * @return {?}
    ...
    ***************************************************************************** */
    ...
    var PasswordComponent = /** @class */ (function (_super) {
        ...
        function PasswordComponent() {
            ...
            _this.passwordChange = new core.EventEmitter();
        ...
        PasswordComponent.propDecorators = {
            ...
            pwdCriteria: [{ type: core.Input }],
            minLen: [{ type: core.Input }],
            maxLen: [{ type: core.Input }],
            errorMessages: [{ type: core.Input }],
            showPasswordStrength: [{ type: core.Input }],
            objectID: [{ type: core.Input }],
            passwordChange: [{ type: core.Output }],
    ...
    var WizardProgressBarComponent = /** @class */ (function () {
        function WizardProgressBarComponent(router$$1, cd) {
         ...
         */
            function () {
                ...
                this.routerEvents$ = this.router.events.pipe(operators.filter(( /**
                 * @param {?} ev
                 * @return {?}
                 */function (ev) { return ev instanceof router.NavigationEnd; })), operators.map(( /**
                 * @param {?} ev
                 * @return {?}
        ...
        */
        ...
        /** @nocollapse */
        WizardProgressBarComponent.ctorParameters = function () {
            return [
                { type: router.Router },
        ...
        WizardProgressBarComponent.propDecorators = {
            ...
            stepContainer: [{ type: core.ViewChild, args: ['stepContainer',] }],
            steps: [{ type: core.ViewChildren, args: ['steps',] }]
        };
    ...
    var DateComponent = /** @class */ (function (_super) {
        ...
        function DateComponent(form, cd) {
            ...
            _this.dateChange = new core.EventEmitter();
            _this.monthList = [
        ...
        DateComponent.propDecorators = {
            monthRef: [{ type: core.ViewChild, args: ['monthRef',] }],
            dayRef: [{ type: core.ViewChild, args: ['dayRef',] }],
            yearRef: [{ type: core.ViewChild, args: ['yearRef',] }],
            useCurrentDate: [{ type: core.Input }],
            required: [{ type: core.Input }],
            disabled: [{ type: core.Input }],
            label: [{ type: core.Input }],
            date: [{ type: core.Input }],
            restrictDate: [{ type: core.Input }],
            errorMessages: [{ type: core.Input }],
    ...
    var DateFieldFormatDirective = /** @class */ (function () {
        function DateFieldFormatDirective() {
            this.ngModelChange = new core.EventEmitter(false);
        }
        /**
         * @param {?} event
         * @return {?}
    ...
    var YearValidateDirective = /** @class */ (function () {
        ...
        YearValidateDirective.propDecorators = {
            commonYearValidate: [{ type: core.Input }]
        };
    ...
    var DatepickerComponent = /** @class */ (function () {
        ...
        DatepickerComponent.propDecorators = {
            ...
            required: [{ type: core.Input }],
            disableUntil: [{ type: core.Input }],
            disableSince: [{ type: core.Input }],
            onlyFutureDates: [{ type: core.Input }],
            clearButton: [{ type: core.Input }],
            dateFormat: [{ type: core.Input }],
            errorMessages: [{ type: core.Input }],
            ngxdp: [{ type: core.ViewChild, args: ['dp',] }]
        };
    ...
    var FileUploaderComponent = /** @class */ (function (_super) {
        ...
        function FileUploaderComponent(zone, cd, router$$1, controlContainer) {
            var _this = _super.call(this) || this;
            _this.zone = zone;
            _this.cd = cd;
        ...
        FileUploaderComponent.prototype.ngOnInit = /*
            ...
            function () {
                var _this = this;
                /** @type {?} */
                var dragOverStream = rxjs.fromEvent(this.dropZone.nativeElement, 'dragover');
                /**
                 * Must cancel the dragover event in order for the drop event to work.
                 */
                dragOverStream.pipe(operators.map(( /**
                 * @param {?} evt
                 * @return {?}
                 */function (evt) {
                    return event;
                ...
                /** @type {?} */
                var dropStream = rxjs.fromEvent(this.dropZone.nativeElement, 'drop');
                /** @type {?} */
                var filesArrayFromDrop = dropStream.pipe(operators.map(( /**
                 * @param {?} event
                 * @return {?}
                 */function (event) {
                ...
                /** @type {?} */
                var browseFileStream = rxjs.fromEvent(this.browseFileRef.nativeElement, 'change');
                // const captureFileStream = fromEvent<Event>(this.captureFileRef.nativeElement, 'change');
                rxjs.merge(rxjs.merge(browseFileStream).pipe(operators.map(( /**
                 * @param {?} event
                 * @return {?}
                 */function (event) {
                    event.preventDefault();
                    return event.target['files'];
                }))), filesArrayFromDrop).pipe(operators.filter(( /**
                 * @param {?} files
                 * @return {?}
                 */function (files) {
                    console.log('files');
         ...
         */
            function () {
                var _this = this;
                /** @type {?} */
                var imagePlaceholderEnterKeyStream = rxjs.merge(rxjs.fromEvent(this.imagePlaceholderRef.nativeElement, 'keyup'), rxjs.fromEvent(this.selectFileLabelRef.nativeElement, 'keyup')).pipe(operators.filter(( /**
                 * @param {?} evt
                 * @return {?}
                 */function (evt) { return evt.key === 'Enter'; })));
                rxjs.merge(rxjs.fromEvent(this.imagePlaceholderRef.nativeElement, 'click'), 
                // fromEvent<Event>(this.uploadInstructionRef.nativeElement, 'click'),
                imagePlaceholderEnterKeyStream).pipe(operators.map(( /**
                 * @param {?} event
                 * @return {?}
                 */function (event) {
                    event.preventDefault();
         ...
         */
            function (fileList, scaleFactors) {
                ...
                // Create our observer
                /** @type {?} */
                var fileObservable = rxjs.Observable.create(( /**
                 * @param {?} observer
                 * @return {?}
                 */function (observer) {
                ...
                })).pipe(operators.retryWhen(this.retryStrategy(32)));
         ...
         */
            function (maxRetry) {
                 ...
                 */function (errors) {
                    ...
                    return errors.pipe(operators.scan((
                    // return errors.pipe(
                    // return errors.pipe(
                    /**
                     * @param {?} acc
        ...
        FileUploaderComponent.propDecorators = {
            dropZone: [{ type: core.ViewChild, args: ['dropZone',] }],
            browseFileRef: [{ type: core.ViewChild, args: ['browseFileRef',] }],
            imagePlaceholderRef: [{ type: core.ViewChild, args: ['imagePlaceholderRef',] }],
            selectFileLabelRef: [{ type: core.ViewChild, args: ['selectFileLabel',] }],
            images: [{ type: core.Input }],
            imagesChange: [{ type: core.Output }],
            id: [{ type: core.Input }],
            showError: [{ type: core.Input }],
            required: [{ type: core.Input }],
            instructionText: [{ type: core.Input }],
            errorMessages: [{ type: core.Input }],
            canvas: [{ type: core.ViewChild, args: ['canvas',] }],
            errorDocument: [{ type: core.Output }]
        };
    ...
    var ThumbnailComponent = /** @class */ (function () {
        function ThumbnailComponent(viewContainerRef) {
            ...
            this.deleteImage = new core.EventEmitter();
        ...
        /** @nocollapse */
        ThumbnailComponent.ctorParameters = function () {
            return [
                { type: core.ViewContainerRef }
            ];
        };
        ThumbnailComponent.propDecorators = {
            imageObject: [{ type: core.Input }],
            reviewMode: [{ type: core.Input }],
            deleteImage: [{ type: core.Output }],
            fullSizeViewModal: [{ type: core.ViewChild, args: ['fullSizeViewModal',] }]
        };
    ...
    exports.ɵa = CoreBreadcrumbComponent;
    exports.ɵi = DateFieldFormatDirective;
    exports.ɵg = DateComponent;
    exports.ɵh = DayValidationDirective;
    exports.ɵj = YearValidateDirective;
    exports.ɵk = DatepickerComponent;
    exports.ɵr = DropdownComponent;
    exports.ɵl = FileUploaderComponent;
    exports.ɵb = FormActionBarComponent;
    exports.ɵn = FormSubmitBarComponent;
    exports.ɵc = PageFrameworkComponent;
    exports.ɵq = PageSectionComponent;
    exports.ɵd = PasswordComponent;
    exports.ɵo = PostalCodeComponent;
    exports.ɵm = ThumbnailComponent;
    exports.ɵs = ToggleComponent;
    exports.ɵf = WizardProgressBarComponent;
    exports.ɵe = Base;
    exports.ɵp = MaskModel;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=moh-common-lib.umd.js.map
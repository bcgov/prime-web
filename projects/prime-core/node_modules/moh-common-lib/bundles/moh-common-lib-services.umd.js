(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs/operators'), require('@angular/core'), require('@angular/common/http'), require('rxjs'), require('moment')) :
    typeof define === 'function' && define.amd ? define('moh-common-lib/services', ['exports', 'rxjs/operators', '@angular/core', '@angular/common/http', 'rxjs', 'moment'], factory) :
    (factory((global['moh-common-lib'] = global['moh-common-lib'] || {}, global['moh-common-lib'].services = {}),global.rxjs.operators,global.ng.core,global.ng.common.http,global.rxjs,global.moment_));
}(this, (function (exports,operators,i0,i1,rxjs,moment_) { 'use strict';
    ...
    ***************************************************************************** */
     ...
     */ AbstractHttpService = /** @class */ (function () {
         ...
         */
            function (observable) {
                ...
                observable = observable.pipe(operators.catchError(this.handleError.bind(this)));
                // Optionally add console logging
                if (this.logHTTPRequestsToConsole) {
                    observable = observable.pipe(operators.tap(( /**
                     * @param {?} data
                     * @return {?}
    ...
    var GeocoderService = /** @class */ (function (_super) {
        ...
        GeocoderService.prototype.lookup =
            ...
            function (address) {
                ...
                return this.get(this.ADDRESS_URL, params).pipe(operators.map(this.processResponse));
            };
        /**
         ...
         */
            function (error) {
                ...
                return rxjs.throwError('Geocoder error');
            };
        ...
        /** @nocollapse */
        GeocoderService.ctorParameters = function () {
            return [
                { type: i1.HttpClient }
            ];
        };
    ...
    var CommonLogger = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        CommonLogger.ctorParameters = function () {
            return [
                { type: i1.HttpClient }
            ];
        };
...
//# sourceMappingURL=moh-common-lib-services.umd.js.map
...
class DateComponent extends Base {
    /**
     * @param {?} form
     * @param {?} cd
     */
    ...
    validate(control) {
        ...
        if (!isNaN(day)) {
            ...
            if (!isNaN(date.month) && !isNaN(date.year)) {
                ...
                /** @type {?} */
                let daysInMonth = moment$1(str, 'YYYY-MM').daysInMonth();
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class DateFieldFormatDirective {
    constructor() {
...
class YearValidateDirective {
    ...
    validate(control) {
        ...
        if (!isNaN(year)) {
            /** @type {?} */
            const currentYear = moment$2().get('y');
            ...
            if (this.commonYearValidate && this.commonYearValidate !== 'any' &&
                ...
                /** @type {?} */
                const diff = moment$2({ year: year, month: date.month, day: date.day })
...
class FileUploaderComponent extends Base {
    /**
     * @param {?} zone
     * @param {?} cd
     * @param {?} router
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class PostalCodeComponent extends MaskModel {
    constructor() {
        super();
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class ToggleComponent extends Base {
    constructor() {
        super();

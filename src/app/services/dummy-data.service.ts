...
export class DummyDataService {
  ...
  populateSiteAccessFromCollectionDemo( collections: PharmaNetOrganization[], people: Person[] ): SiteAccess[] {
    ...
    sa = this.createSiteAccessAndAssociateDemo(collections[0].members[0], people[0], access[0], collections[0]); // New
    result.push(sa);
    sa = this.createSiteAccessAndAssociateDemo(collections[0].members[3], people[0], access[9], collections[0]); // New
    result.push(sa);
    ...
    sa = this.createSiteAccessAndAssociateDemo(collections[1].members[3], people[1], access[4], collections[1]);
    result.push(sa);
    sa = this.createSiteAccessAndAssociateDemo(collections[1].members[0], people[1], access[6], collections[1]);
    result.push(sa);
    sa = this.createSiteAccessAndAssociateDemo(collections[0].members[0], people[1], access[2], collections[0]);
    result.push(sa);

    // Third Person - Expired
    sa = this.createSiteAccessAndAssociateDemo(collections[1].members[1], people[2], access[8], collections[1]);
    result.push(sa);
    ...
    sa = this.createSiteAccessAndAssociateDemo(collections[1].members[2], people[3], access[5], collections[1]);
    result.push(sa);
    ...
    sa = this.createSiteAccessAndAssociateDemo(collections[0].members[3], people[4], access[7], collections[0]);
    sa = this.createSiteAccessAndAssociateDemo(collections[0].members[1], people[4], access[10], collections[0]);
    result.push(sa);

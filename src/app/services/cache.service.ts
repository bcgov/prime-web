...
export class CacheService {
  ...
  /**
   * Province list { provCode: string, name: string }
   * TODO: Data to be stored in database and pushed to cache service, confirm format of JSON
   *       message and REST call
   */
  public provinceList = [
    { provCode: 'AB', name: 'Alberta' },
    { provCode: 'BC', name: 'British Columbia' },
    { provCode: 'MB', name: 'Manitoba' },
    { provCode: 'NB', name: 'New Brunswick' },
    { provCode: 'NL', name: 'Newfoundland and Labrador' },
    { provCode: 'NS', name: 'Nova Scotia' },
    { provCode: 'ON', name: 'Ontario' },
    { provCode: 'PE', name: 'Prince Edward Island' },
    { provCode: 'QC', name: 'Quebec' },
    { provCode: 'SK', name: 'Saskatchewan' },
    { provCode: 'NT', name: 'Northwest Territories' },
    { provCode: 'NU', name: 'Nunavut' },
    { provCode: 'YT', name: 'Yukon' }
  ];
